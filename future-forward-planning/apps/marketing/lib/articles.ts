...
export type CoverKind = "docs" | "chart" | "swap" | "doc" | "pause" | "sheet" | "note";
...
export const ARTICLES: ArticleSummary[] = [
  {
    ...
    read: "6 min read",
    excerpt:
      "A plain-English summary of the updated price guide, the support categories affected, and what participants should ask their plan manager before their next invoice cycle.",
    cover: "docs",
  },
  {
    slug: "pacing-core",
    ...
    read: "4 min read",
    excerpt:
      "Three simple checks to run on your core supports budget before end of financial year — and when to request a plan variation.",
    cover: "chart",
  },
  {
  ...
  },
  {
    ...
    read: "5 min read",
    excerpt:
      "A short explainer on the category that funds plan management, and why getting the right wording on your plan matters at review time.",
    cover: "note",
  },
];

export const ARTICLE_DATA: Record<string, Article> = {
  "pricing-2026": {
    title: "What the 2026 NDIS pricing arrangements mean for participants",
    cat: "Regulatory",
    date: "14 April 2026",
  ...
  "invoice-records": {
    ...
    read: "3 min read",
    image:
      "https://images.unsplash.com/photo-1568992688413-7b0bc7e6fef9?w=1200&q=80&auto=format&fit=crop",
  ...
  "monthly-statement": {
    ...
    read: "5 min read",
    image:
      "https://images.unsplash.com/photo-1579621970563-ebec7e6e4f85?w=1200&q=80&auto=format&fit=crop",
  ...
  "improved-life-choices": {
    ...
    read: "5 min read",
    image:
      "https://images.unsplash.com/photo-1434626881859-086134fd7db8?w=1200&q=80&auto=format&fit=crop",
